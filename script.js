...
const databaseProdotti = {
    ...
    // NUOVO PRODOTTO AGGIUNTO: GLOBALMAG
    "globalmag": {
        titolo: "Globalmag - Dispositivo Multifunzione 5 in 1",
        descrizione: "Apparecchio professionale Made in Italy con ampio touch screen da 7 pollici: unisce in un solo dispositivo Magnetoterapia, Elettroterapia, Ultrasuoni, Radiofrequenza e Cromoterapia. Tecnica utilizzata anche negli ospedali.",
        immagini: ["Globalmag.png"],
        dettagli: `
            <h4>Trattamenti Inclusi:</h4>
            <ul>
                <li><strong>5 Terapie in 1:</strong> Magnetoterapia, Elettroterapia, Ultrasuoni, Radiofrequenza e Cromoterapia.</li>
                <li><strong>Interfaccia:</strong> Ampio touch screen da 7 pollici con programmi personalizzabili.</li>
            </ul>
            <h4>Caratteristiche Tecniche:</h4>
            <ul>
                <li>Dimensioni (LxPxA): 33,5 x 10 x 27,5 cm. Peso netto: 3 Kg.</li>
                <li>Alimentazione esterna: 110-240Vac, 24Vcc.</li>
                <li>Frequenza di lavoro con sistema Dual: Max BF 100Hz - Max HF 27.1 MHz.</li>
                <li>Elettrostimolazione da 2,5 Hz a 100 Hz con forma d'onda bifasica quadra asimmetrica.</li>
                <li>Ultrasuonoterapia: potenza max 3W/cm², frequenza di lavoro da 0,8 a 3 MHz.</li>
                <li>Cromoterapia: emissione luminosa da 470 nm e 635 nm con diffusore PLUS LIGHT.</li>
                <li>Radiofrequenza bipolare: da 700 a 800 KHz.</li>
            </ul>
            <h4>Certificazioni:</h4>
            <ul>
                <li>Prodotto Made in Italy, con Certificato del Ministero della Salute (Dispositivo Medico CE).</li>
                <li>Tecnica utilizzata anche in ambito ospedaliero.</li>
            </ul>
        `
    }
};
